...
This data set contains data from the MN Census. It contains many different variables and is based on the Minnesota Counties data. A link to the code book: Codebook.xlsx on https://github.com/torihagstrom/SeniorPracticumProject.
...
Finding the variable names of the **mpg** data set in `ggplot2` library
...
Using the *mpg data set* in the `ggplot2` package, we can add city to highway ratio and the standard deviation of highway. Now mutated into the new subset data set, we can see there are two more variables added to the data set. 
link to online description: https://ggplot2.tidyverse.org/reference/mpg.html
...
#filters both hwy>20 and cty = 18
mpg %>%
